...
- q3.txt: 总成本上升 0
写入开销估计：
- OP1 RedundantColumnAdd: UPDATE≈9.98e+05
- OP2 TableJoin: INSERT≈2e+06
- OP3 RedundantColumnAdd: UPDATE≈9.98e+05

逐操作效果（基于 runner per-step 汇总）：
- 第1步 RedundantColumnAdd: 单步上升 0，累计 +0；命中改写比≈0.0%
- 第2步 TableJoin: 单步上升 0，累计 +0；命中改写比≈0.0%
- 第3步 RedundantColumnAdd: 单步上升 0，累计 +0；命中改写比≈0.0%
