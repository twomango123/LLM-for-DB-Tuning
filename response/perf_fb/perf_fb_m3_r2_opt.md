受影响计划覆盖率：7/16（43.8%）；样本：q1.txt, q2.txt, q6.txt, q7.txt, q9.txt …
性能评估对比（cost）：
- 初始基线：197912702237 cost
- 预测结果：98305789069 cost（改善 99606913168）
代表性查询净效应：
- q7.txt: 总成本下降 9.96e+10
- q9.txt: 总成本下降 2.43e+06
- q2.txt: 总成本下降 1.35e+06
写入开销估计：
- OP2 RedundantColumnAdd: UPDATE≈9.99e+05
- OP3 TableJoin: INSERT≈2e+06
- OP4 TableJoin: INSERT≈2e+06

逐操作效果（基于 runner per-step 汇总）：
- 第1步 VerticalSplit: 单步上升 0，累计 +0；命中改写比≈0.0%
- 第2步 RedundantColumnAdd: 单步上升 0，累计 +0；命中改写比≈0.0%
- 第3步 TableJoin: 单步上升 0，累计 +0；命中改写比≈0.0%
- 第4步 TableJoin: 单步上升 0，累计 +0；命中改写比≈0.0%
