...
`cp -r output_dir/rewritten /var/lib/mysql-files/output_dir/rewritten`
...
### 根据当前数据库信息构造提示词  
```python  
python3 prompt/COMBINATION.py --schema-sql output_dir/schema.sql --csv-dir output_dir/ --sql-dir output_dir --latency query_latency/latency_results.csv --out prompt/final_prompt.md
``` 
...
### 负载生成压缩  
拷贝查看  
docker cp 4c539dc58099:LLM-for-DB-Tuning/prompt/final_prompt.md ./final_prompt.md
### 运行ch-benchmark测试
